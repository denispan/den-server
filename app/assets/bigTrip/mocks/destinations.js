export const MOCK_DESTINATIONS = [
  {
    ...
    'pictures': [
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/5.jpg',
        'description': 'Vien a true asian pearl'
      },
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/9.jpg',
        'description': 'Vien for those who value comfort and coziness'
      }
    ]
  },
  {
    ...
    'pictures': [
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/20.jpg',
      ...
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/8.jpg',
        'description': 'Geneva is a beautiful city'
      },
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/15.jpg',
        'description': 'Geneva middle-eastern paradise'
      }
    ]
  },
  {
    ...
    'pictures': [
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/10.jpg',
  ...
  },
  {
    ...
    'pictures': [
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/19.jpg',
        'description': 'Munich is a beautiful city'
      },
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/1.jpg',
        'description': 'Munich in a middle of Europe'
      },
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/4.jpg',
  ...
  },
  {
    ...
    'pictures': [
      ...
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/2.jpg',
  ...
  },
  {
    ...
    'pictures': [
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/16.jpg',
        'description': 'Chamonix full of of cozy canteens where you can try the best coffee in the Middle East'
      },
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/7.jpg',
        'description': 'Chamonix for those who value comfort and coziness'
      },
      {
        'src': 'https://denpan.ru/assets/bigTrip/images/destinations/15.jpg',
